...
### R Packages:
**tidyverse**: This collection of R packages was fundamental to our data wrangling and manipulation efforts. Packages like `dplyr`, `tibble`, and `tidyr` were used extensively to clean, format, and merge data. [Tidyverse Documentation](https://www.tidyverse.org/)
**sf**: For handling and visualizing geospatial data, we used the `sf` package, which enabled us to manage shapefiles and perform spatial joins. This package was crucial for creating accurate maps that displayed socio-economic trends across Victoria. [sf Documentation](https://r-spatial.github.io/sf/)
**ggplot2**: A core part of the `tidyverse`, `ggplot2` was essential for creating data visualizations. We used it to generate line graphs, bar charts, and detailed maps that captured population projections and SES variations over time. [ggplot2 Documentation](https://ggplot2.tidyverse.org/)
**zoo**: This package was used to manage and analyze time series data, which was particularly useful for projecting Year 12-ready populations over the 2021-2030 period. [zoo Documentation](https://cran.r-project.org/web/packages/zoo/)
**readxl**: To import and process Excel files containing demographic and socio-economic data, we relied on the `readxl` package, which facilitated seamless integration of external datasets. [readxl Documentation](https://readxl.tidyverse.org/)
