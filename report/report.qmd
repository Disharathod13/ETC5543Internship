...
# 'data_long' contains population information, and 'SAregions_AUS' contains region information
...
# Check the structure of 'summarized_data' to confirm the data types and structure are as expected
summarized_data %>%
...
ggplot(thetable, aes(x = Year, y = Population, group = 1)) +
